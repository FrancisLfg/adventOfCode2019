...
test3 = TestCase (assertEqual "For a mass of 1969, the fuel required is 654" 654 (day1_n computeFuel "1969"))

test4 = TestCase (assertEqual "For a mass of 100756, the fuel required is 33583" 33583 (day1_n computeFuel "100756"))
